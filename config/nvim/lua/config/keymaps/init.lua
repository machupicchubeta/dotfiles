...
-- vim.keymap.set('c', '<C-k>', vim.cmd('<C-\\>e getcmdpos() == 1 ? "" : getcmdline()[:getcmdpos()-2]<CR>'))
...
--
-- vim.keymap.set('n', '[Space].', ':<C-u>call ToggleOption("relativenumber")<CR>', { silent = true })
-- vim.keymap.set('n', '[Space]m', ':<C-u>call ToggleOption("paste")<CR>:set mouse=<CR>', { silent = true })
-- vim.keymap.set('n', '[Space]/', ':<C-u>call ToggleOption("hlsearch")<CR>', { silent = true })
-- vim.keymap.set('n', '[Space]cl', ':<C-u>call ToggleOption("cursorline")<CR>', { silent = true })
-- vim.keymap.set('n', '[Space]ar', ':<C-u>setlocal autoread<CR>')
-- vim.keymap.set('n', '[Space]p', ':<C-u>call ToggleOption("spell")<CR> : set spelllang=en_us<CR> : set spelllang+=cjk<CR>')
-- vim.keymap.set('n', '[Space]w', ':<C-u>call ToggleOption("wrap")<CR>')
--
--
...
-- endfunction  "}}}
--
-- vim.keymap.set('n', '<silent> [Alt]p o<Esc>pm``[=`]``^
-- vim.keymap.set('x', '<silent> [Alt]p o<Esc>pm``[=`]``^
-- vim.keymap.set('n', '<silent> [Alt]P O<Esc>Pm``[=`]``^
-- vim.keymap.set('x', '<silent> [Alt]P O<Esc>Pm``[=`]``^
...
--
-- vim.keymap.set('n', '<ESC><ESC>', ':nohlsearch<CR>:match<CR>')
--
--
-- vim.keymap.set('n', '<silent> #    <C-^>
...
vim.keymap.set('n', 'sT', '<Cmd>Unite tab<CR>')
...
vim.keymap.set('n', '<Leader>P', '<Cmd><C-u>cfirst<CR>')
vim.keymap.set('n', '<Leader>N', '<Cmd><C-u>clast<CR>')
